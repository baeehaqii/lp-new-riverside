  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "Lokasi Sapphire Riverside di Jl. Gunung Slamet, Pabuaran, Grendeng, Purwokerto Utara, Kab. Banyumas. Lokasinya dekat dengan fasilitas umum. Hanya 3 menit dari UNSOED, 7 menit dari RST Wijaya Kusuma,1 menit dari minimarket, dan 1 menit dari kafe, kedai kopi, dan semacamnya.",
    },
    {
      question: "Apa saja fasilitas umum yang disediakan di dalam Sapphire Riverside?",
      answer:
        "Di Sapphire Riverside, kami menghadirkan lingkungan dengan fasilitas modern dan nyaman. Jalan di dalam kompleks lebih lebar (jalan utama 8 meter dan jalan lingkungan 6 meter), jadi tidak perlu khawatir soal akses atau parkir. Kami juga mengutamakan keamanan dengan one gate system dan penjagaan dari sekuriti selama 24 jam untuk menjaga kawasan tetap aman.",
    },
    {
      question: "Apakah rumah di Sapphire Riverside sudah memiliki sertifikat hak milik (SHM)?",
      answer:
        "Di Sapphire Riverside, kami sudah mengurus proses pemecahan sertifikat, jadi saat serah terima nanti, sertifikatnya langsung atas nama Bapak/Ibu. Hal ini mempermudah dan mempercepat proses kepemilikan tanpa perlu menunggu lama untuk pengurusan balik nama. Kami memastikan urusan administrasi menjadi lebih praktis untuk Bapak/Ibu, jadi begitu Anda menerima kunci, status kepemilikan sudah resmi atas nama Anda.",
    },
    {
      question: "Apakah sertifikat ini aman dari masalah hukum di kemudian hari?",
      answer:
        "Mengenai legalitas di Sapphire Riverside, semua sudah lengkap dan aman, Bapak/Ibu. Properti di sini dilengkapi Sertifikat Hak Milik (SHM), jadi kepemilikannya jelas atas nama pembeli. Izin bangunannya juga sudah ada melalui Persetujuan Bangunan Gedung (PBG), artinya bangunan sudah sesuai aturan dan aman.",
    },
    {
    ...
    {
      question: "Apakah rumah di Sapphire Riverside sudah memiliki PBG?",
      answer:
        "Rumah di Sapphire Riverside sudah memiliki Persetujuan Bangunan Gedung (PBG), jadi Anda tidak perlu khawatir soal legalitas bangunan ini. PBG ini memastikan bahwa proses pembangunan sudah sesuai dengan peraturan yang berlaku, sehingga hunian di sini aman dan sah untuk ditinggali, maupun sebagai investasi jangka panjang.",
    },
    {
    ...
    <section id="faq" className="faq-section">
      <div className="container">
        <div className="faq-header">
          <h2 className="faq-title">Pertanyaan Umum Sapphire Riverside</h2>

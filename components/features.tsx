import { ShieldCheck, Trees, Cctv, Lock, CircleMinus, IdCard, Road, Car } from "lucide-react"
  ...
  const features = [
{
  ...
  {
    icon: <Lock />, // Mengganti <Trees> dengan <Lock> untuk "Privasi"
  ...
  {
    icon: <Car />, // Mengganti <Cctv> dengan <Road> untuk "Jalan"
  ...
  {
    icon: <Trees />, // Mengganti <CarFront> dengan <Trees> untuk "Taman"
  ...
  return (
    <section id="fasilitas" className="features-section">
      <div className="container">
        <h2 className="section-title">Your Future Prosperity</h2>
        <p className="section-subtitle">
          Hunian Nyaman Sekaligus Aset Investasi Menjanjikan
        </p>
